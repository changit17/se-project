...
<!-- Modal -->
  ...
  <!--SECTION SECTION -->
   <form method="post">  
  <div class="modal fade" id="AddYear" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
      ...
      <label class='control-label' for="su_name">Year Name</label>
      <input type="text" class="form-control" name="year_name" required maxlength="3">
    </div>      
    </div>

        <div class="modal-footer">
    <button type="submit" class="btn btn-primary" name ="submit_Year">Add</button>  
