  <!-- Navigation -->
        ...
        <div class="form-group">
          <input type="text" class="form-control" placeholder="Search" name="search_name" value="" disabled >
        </div>
        <button type="submit" class="btn btn-success" disabled><i class="fa fa-fw fa-search"></i></button>
      </form>
      <!-- Searchbar -->
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                <a href="auth/index.php"  ><i class="fa fa-user"></i><b >Logout</b></a>
