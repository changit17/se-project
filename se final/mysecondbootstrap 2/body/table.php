...
<a href="students_enrolled.php" class="btn btn-info btn-xs" >
  <i class="fa fa-fw fa-list"> </i>List of Enrolled Students
</a>
</td>
...
////search student/////
        ...
        $get=mysql_query("SELECT * FROM student_tbl INNER JOIN department_tbl USING(d_id) INNER JOIN course_tbl USING(c_id) WHERE s_id LIKE '%$result%'  ORDER BY s_id  ");
