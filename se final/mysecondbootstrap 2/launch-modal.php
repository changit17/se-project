    ...
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="s_id" placeholder="1234" required>
        </div>                
        <div class="form-group">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-info" name ="submit_info">Save</button> 
        </div>
  ...
  <div class="modal fade" id="AddDept" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        ...
        <div class="form-group">
          <label class='control-label' for="dean_name">Dean Name</label>
          <input type="text" class="form-control" name="dean_name" required>
        </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-info" name ="submit_dept">Add</button> 
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="AddCourse" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-info" name ="submit_course">Add</button> 
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="AddSubj" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="form-group">
      ...
      ?>
        ...
        <div class="modal-footer">
    <button type="submit" class="btn btn-info" name ="submit_section">Add</button>  
